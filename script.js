...
$('.tin').on('mousedown touchstart', function(event) {
    $(this).draggable({
        revert: true
    });
});

$('.oven').on('mouseup touchend', function(event) {
    $('.stage3').fadeOut();
...
// Finalize the cake-making process
function fin() {
...
// Event to finalize the cake
$('.add').click(function(){
    fin();
});

// Reload the page on clicking "start again"
$('.sa').click(function(){
